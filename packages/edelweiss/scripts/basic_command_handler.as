...
class BasicCommandHandler : Tracker {
	...
	protected void handleChatEvent(const XmlElement@ event) {
		...
		} else  if(checkCommand(message, "ghost")) {
			// .. ghost vest!
			spawnInstanceNearPlayer(senderId, "ghost_vest.carry_item", "carry_item");
...
*/		} else  if(checkCommand(message, "guntruck")) {
		...
		} else if (checkCommand(message, "garand")) {
			spawnInstanceNearPlayer(senderId, "m1_garand.weapon", "weapon", 0); 
			spawnInstanceNearPlayer(senderId, "m1_garand.weapon", "weapon", 0); 
			spawnInstanceNearPlayer(senderId, "m1_garand.weapon", "weapon", 0); 
			spawnInstanceNearPlayer(senderId, "m1_garand.weapon", "weapon", 0); 
			spawnInstanceNearPlayer(senderId, "m1_garand.weapon", "weapon", 0); 
			spawnInstanceNearPlayer(senderId, "m1_garand_b.weapon", "weapon", 0);
			spawnInstanceNearPlayer(senderId, "m1_garand_b.weapon", "weapon", 0);
			spawnInstanceNearPlayer(senderId, "m1_garand_b.weapon", "weapon", 0);
			spawnInstanceNearPlayer(senderId, "m1_garand_b.weapon", "weapon", 0);
			spawnInstanceNearPlayer(senderId, "m1_garand_b.weapon", "weapon", 0);
