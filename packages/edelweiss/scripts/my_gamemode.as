...
#include "my_stage_configurator_allies_invasion.as"
#include "my_stage_configurator_axis_invasion.as"
...
*/
	...
	protected void setupMapRotator() {
		...
		if (!isInServerMode()) {
			...
			if (getUserSettings().m_factionChoice == 0) {
				MyStageConfiguratorAlliesInvasion configurator(this, mapRotator);
			} else {
				MyStageConfiguratorAxisInvasion configurator(this, mapRotator);
			}
		}
