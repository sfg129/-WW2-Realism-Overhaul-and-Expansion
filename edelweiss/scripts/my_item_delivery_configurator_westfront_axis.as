...
// ------------------------------------------------------------------------------------------------
class MyItemDeliveryConfigurator_WH : MyItemDeliveryConfigurator {
	// ------------------------------------------------------------------------------------------------
	MyItemDeliveryConfigurator_WH(GameModeInvasion@ metagame) {
		super(metagame);
	}
	
	// --------------------------------------------
	array<Resource@>@ getUnlockItemList() const {
		return getUnlockItemListAxis();
	}
...
//		list.push_back(Resource("delisle.weapon", "weapon"));
	...
	array<Resource@>@ getDeliverablesList() const {
		...
		//list.push_back(Resource("m1903_rifle_s.weapon", "weapon"));
		...
		//Allied weapons
		list.push_back(Resource("smle_no4_mki.weapon", "weapon"));     
		list.push_back(Resource("sten_mkii.weapon", "weapon"));     
		list.push_back(Resource("sten_mkv.weapon", "weapon"));     
		list.push_back(Resource("bren.weapon", "weapon"));     
		list.push_back(Resource("smle_no4_mki_s.weapon", "weapon"));     

		list.push_back(Resource("m1903_rifle.weapon", "weapon"));     		
		list.push_back(Resource("m1_garand.weapon", "weapon"));     
		list.push_back(Resource("m3_greasegun.weapon", "weapon"));     
		list.push_back(Resource("m1918_bar_heavy.weapon", "weapon"));     
		list.push_back(Resource("m1919_lmg_light.weapon", "weapon"));     
		list.push_back(Resource("m1903a4_rifle_s.weapon", "weapon"));     
