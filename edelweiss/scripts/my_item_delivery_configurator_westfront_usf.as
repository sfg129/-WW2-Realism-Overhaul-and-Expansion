...
// ------------------------------------------------------------------------------------------------
class MyItemDeliveryConfigurator_USF : MyItemDeliveryConfigurator {
	// ------------------------------------------------------------------------------------------------
	MyItemDeliveryConfigurator_USF(GameModeInvasion@ metagame) {
		super(metagame);
	}
	
	// --------------------------------------------
	array<Resource@>@ getUnlockItemList() const {
		return getUnlockItemListUsf();
	}
...
//		list.push_back(Resource("delisle.weapon", "weapon"));
	...
	array<Resource@>@ getDeliverablesList() const {
		...
		list.push_back(Resource("mg34.weapon", "weapon"));  		
