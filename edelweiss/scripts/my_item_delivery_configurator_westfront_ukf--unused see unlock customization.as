...
// ------------------------------------------------------------------------------------------------
class MyItemDeliveryConfigurator_UKF : MyItemDeliveryConfigurator {
	// ------------------------------------------------------------------------------------------------
	MyItemDeliveryConfigurator_UKF(GameModeInvasion@ metagame) {
		super(metagame);
	}
	...
	array<Resource@>@ getUnlockItemList() const {
		...
		list.push_back(Resource("smle_rifle_grenade_he.weapon", "weapon"));
		
		//secondary weapon unlocks
		list.push_back(Resource("browning_hp_carbine.weapon", "weapon"));
		list.push_back(Resource("austen_mki_folded.weapon", "weapon"));
...
//		list.push_back(Resource("delisle.weapon", "weapon"));
	...
	array<Resource@>@ getDeliverablesList() const {
		...
		//WH weapons
		list.push_back(Resource("kar98k.weapon", "weapon"));     
		list.push_back(Resource("kar43.weapon", "weapon"));     
		list.push_back(Resource("mp40.weapon", "weapon"));     
		list.push_back(Resource("mg42.weapon", "weapon"));     
		list.push_back(Resource("kar98k_s.weapon", "weapon"));     
