...
#include "phase_controller_island7.as"
#include "call_sorting.as"
#include "base_resource_controller_island4.as"
...
class StageConfiguratorInvasion : StageConfigurator {
	...
	const array<FactionConfig@>@ getAvailableFactionConfigs() const {
		...
		availableFactionConfigs.push_back(FactionConfig(-1, "usmc.xml", "USMC", "0.5 0.5 0.9", "usmc.xml"));
		availableFactionConfigs.push_back(FactionConfig(-1, "ija.xml", "IJA", "0.9 0.5 0.5", "ija.xml"));
